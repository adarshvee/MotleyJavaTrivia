...
public class APojoHashedUsingUtilMethod extends APojoBase{

    public APojoHashedUsingUtilMethod(Long id, String firstName, String lastName, int addressId, String comments, Timestamp registeredDate, double userRating) {
